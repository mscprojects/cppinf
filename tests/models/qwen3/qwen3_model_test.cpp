...
class Qwen3ModelTest : public ::testing::Test {
  ...
  private:
    ...
    void write_weights_file() {
        ...
        append_bf16_matrix(
            header, tensor_data, "model.embed_tokens.weight",
            {
        ...
        append_bf16_matrix(
            header, tensor_data, "model.layers.0.self_attn.q_proj.weight",
            {
        ...
        append_bf16_matrix(
            header, tensor_data, "model.layers.0.self_attn.k_proj.weight",
            {
        ...
        append_bf16_matrix(
            header, tensor_data, "model.layers.0.self_attn.v_proj.weight",
            {
        ...
        append_bf16_matrix(
            header, tensor_data, "model.layers.0.self_attn.o_proj.weight",
            {
                {-0.98046875f, -0.1298828125f, 0.71875f, -0.02001953125f, 0.48046875f, 0.96875f, -1.1015625f,
                 -0.94921875f},
                {0.51953125f, -0.2099609375f, -1.046875f, -0.41015625f, 0.6484375f, 0.33984375f, 0.890625f,
                 -0.87109375f},
                {-0.80078125f, 0.02001953125f, -0.51953125f, -0.150390625f, -0.640625f, -0.6484375f,
                 0.02001953125f, 1.0703125f},
                {0.98828125f, -0.98046875f, 0.369140625f, 1.03125f, -0.1201171875f, -0.41015625f, -0.33984375f,
                 0.828125f},
                {-0.26953125f, 0.1396484375f, 0.33984375f, -0.419921875f, -0.5f, -0.1298828125f, 0.859375f,
                 -0.87109375f},
                {0.2890625f, 1.0625f, -0.26953125f, -1.0078125f, 0.48046875f, -0.1396484375f, -0.150390625f,
                 -0.06982421875f},
            });
        append_bf16_matrix(
        ...
        append_bf16_matrix(
            header, tensor_data, "model.layers.0.mlp.up_proj.weight",
            {
        ...
        append_bf16_matrix(
            header, tensor_data, "model.layers.0.mlp.down_proj.weight",
            {
                {-0.859375f, 0.1796875f, 0.71875f, -0.2197265625f, 0.44921875f, -0.44921875f, 0.66015625f,
                 0.859375f, -0.5390625f, -0.76953125f},
                ...
                {-0.87890625f, 0.380859375f, -0.98828125f, -1.03125f, 0.51953125f, -0.80078125f, -0.640625f,
                 -0.83984375f, -0.8515625f, -1.078125f},
                {0.2001953125f, -0.73828125f, 0.26953125f, -0.69921875f, 0.10986328125f, 0.41015625f,
                 -0.4609375f, 1.0f, -0.30078125f, 0.26953125f},
                {-0.1201171875f, 0.10986328125f, 0.439453125f, -0.6015625f, -0.470703125f, -0.06005859375f,
                 1.03125f, 0.96875f, 0.1904296875f, 0.2890625f},
        ...
        append_bf16_matrix(
            header, tensor_data, "model.layers.1.self_attn.q_proj.weight",
            {
        ...
        append_bf16_matrix(
            header, tensor_data, "model.layers.1.self_attn.k_proj.weight",
            {
        ...
        append_bf16_matrix(
            header, tensor_data, "model.layers.1.self_attn.v_proj.weight",
            {
        ...
        append_bf16_matrix(
            header, tensor_data, "model.layers.1.self_attn.o_proj.weight",
            {
                {0.3203125f, -0.69921875f, -0.55859375f, -0.2099609375f, -0.94140625f, -0.7890625f, 0.828125f,
                 -1.0703125f},
                {0.16015625f, -0.5f, -0.4296875f, 0.16015625f, 0.91015625f, 0.259765625f, -0.5703125f,
                 -1.1015625f},
                {0.25f, 0.87109375f, -0.490234375f, 0.240234375f, -0.150390625f, -0.55078125f, 1.0f, 0.69140625f},
                {-0.4296875f, -0.55078125f, 0.98046875f, -0.91015625f, -1.0390625f, 0.890625f, 1.09375f,
                 0.859375f},
                {-0.8203125f, 0.6015625f, 0.859375f, 0.30078125f, 1.0234375f, 0.380859375f, 1.1015625f,
                 -1.078125f},
                {0.71875f, -0.87109375f, -0.609375f, 0.921875f, -0.419921875f, 0.150390625f, 0.73046875f,
                 -0.02001953125f},
            });
        append_bf16_matrix(
            header, tensor_data, "model.layers.1.mlp.gate_proj.weight",
            {
        ...
        append_bf16_matrix(
            header, tensor_data, "model.layers.1.mlp.up_proj.weight",
            {
        ...
        append_bf16_matrix(
            header, tensor_data, "model.layers.1.mlp.down_proj.weight",
            {
                {-0.369140625f, -0.380859375f, 0.87109375f, -0.53125f, 0.76171875f, -0.050048828125f,
                 -0.51171875f, 0.419921875f, -0.66015625f, -0.390625f},
                {0.7890625f, 0.640625f, -0.76171875f, -1.0703125f, -0.16015625f, -0.73046875f, -0.51953125f, -0.5f,
                 -0.030029296875f, 0.279296875f},
                {-0.06982421875f, 0.53125f, -0.671875f, -0.0f, 0.51171875f, 0.30078125f, -0.1796875f, 0.2890625f,
                 -0.2197265625f, -0.73828125f},
                ...
                {0.51953125f, 0.330078125f, -0.5703125f, 0.44921875f, 0.169921875f, 0.859375f, 0.06005859375f,
                 -0.369140625f, -0.1201171875f, 0.1201171875f},
            });
...
TEST_F(Qwen3ModelTest, GivenTinyBf16Checkpoint_WhenRunningForward_ThenExpectedLogitsAreReturned) {
    ...
    expect_bf16_values_near(
        logits,
        {0.296875f, 0.12451171875f, 0.283203125f, 1.5f, 4.28125f, -0.0245361328125f, -1.609375f, -1.421875f,
         0.96484375f, 1.2109375f, -2.515625f, 0.859375f, -2.828125f, 1.4921875f, -0.1884765625f, -0.59375f,
         1.2265625f, 4.71875f, 0.84375f, -2.828125f, -1.6640625f, 0.7109375f, 1.4453125f, -2.4375f, 0.26171875f,
         -2.78125f, 1.6640625f, 1.609375f, -0.8203125f, 3.171875f, 4.5625f, 2.390625f, -2.328125f, -1.9375f,
         1.7890625f, 1.078125f, -2.203125f, -0.1044921875f, -3.6875f, -1.6328125f, -1.03125f, 0.66015625f,
         -2.046875f, 0.6640625f, -1.3125f, 0.73046875f, 0.6015625f, -0.314453125f, 2.296875f, -1.7578125f,
         -0.298828125f, 0.51953125f},
        1e-6f);
}
