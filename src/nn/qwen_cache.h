...
// Allocates fixed-capacity K/V tensors for one attention layer.
...
// Appends current rotated keys and values to cache without reallocating when storage already exists.
